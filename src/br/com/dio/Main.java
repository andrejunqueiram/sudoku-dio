...
public class Main {
    ...
    private static void inputNumber() {
        ...
        System.out.println("Informe a coluna que o número deverá ser inserido:");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha que o número deverá ser inserido:");
    ...
    private static void removeNumber() {
        ...
        System.out.println("Informe a coluna que o número deverá ser removido:");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha que o número deverá ser removido:");
        var row = runUntilGetValidNumber(0, 8);
    ...
    private static void clearGame() {
        ...
        while (!confirm.equalsIgnoreCase("sim") && !confirm.equalsIgnoreCase("não")) {
            System.out.println("Informe um valor válido (sim/não):");
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()) {
            ...
            System.out.println("Ainda precisa de preencher alguns números.");
